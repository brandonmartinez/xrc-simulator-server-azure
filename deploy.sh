...
export XRC_SERVER_NAME="${XRC_SERVER_NAME:-xRC Azure Server}"
export XRC_WEB_ADMIN_PORT="${WEB_ADMIN_PORT:-8080}"
export XRC_WEB_ADMIN_BIND="${WEB_ADMIN_BIND:-0.0.0.0}"
export XRC_BACKUP_RETENTION="${XRC_BACKUP_RETENTION:-3}"
export XRC_DAILY_RESTART_ENABLED="${XRC_DAILY_RESTART_ENABLED:-true}"
export XRC_DAILY_RESTART_TIME="${XRC_DAILY_RESTART_TIME:-04:00}"
envsubst '${XRC_ADMIN_USERNAME} ${XRC_DOWNLOAD_URL} ${XRC_GAME_PORT} ${XRC_SERVER_PASSWORD} ${XRC_SERVER_USERNAME} ${XRC_GAME} ${XRC_SERVER_NAME} ${XRC_WEB_ADMIN_PORT} ${XRC_WEB_ADMIN_BIND} ${XRC_BACKUP_RETENTION} ${XRC_DAILY_RESTART_ENABLED} ${XRC_DAILY_RESTART_TIME}' \
